...
# BOUNDS_FULL = np.array([
#     (-0.256978000048548, 0.24302199995145202),     # snw_att
#     (0.37037488222122195, 0.6878390669822693),      # snw_pmf
#     (0.030288999527692796, 0.056250999122858046),     # snw_amf
#     (68.54062347412109, 100),    # sl0_dth
#     (428.45263671875, 700),    # sl0_pwp
#     (114.33974914550781, 212.34524841308593),  # sl0_fcy
#     (2.03913996219635, 3.7869742155075072),    # sl0_bt0
#     (0.6782537996768951, 1.2596141993999481),     # urr_dth
#     (1.1802125930786134, 2.191823387145996),    # lrr_dth
#     (0.6906668841838837, 1),      # urr_wsr
#     (0.1263695999979973, 0.23468639999628066),      # urr_ulc
#     (28.17144317626953, 52.31839447021484),    # urr_tdh
#     (0.4800620973110199, 0.8915438950061798),     # urr_tdr
#     (1.3999999646330253e-05, 2.5999999343184756e-05),      # urr_ndr
#     (7.700000060140155e-05, 0.0001430000011168886),      # urr_uct
#     (0.006336400005966425, 0.011767600011080504),      # lrr_dre
#     (3.499999911582563e-06, 6.499999835796189e-06),      # lrr_dct
# ], dtype=np.float32)
# # ============================================================================
# OBJECTIVE FUNCTIONS
# ============================================================================
...
def main():
    ...
    # Use relative path from script location (more portable)
    # Fallback to current working directory for notebook execution
    try:
    ...
    # Output directory
    out_dir = script_dir / 'outputs'/ 'Assignment3'
    ...
    try:
        ...
        cca_srs = pd.read_csv('area___24163005.csv', sep=';', index_col=0)
    ...
    N = 524288  # Must be power of 2 (2^19)
