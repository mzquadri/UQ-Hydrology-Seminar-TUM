...
# Add parent directories to Python path so 'hmg' module can be found
script_dir = Path(__file__).resolve().parent  # hmg_cython/hmg/test/
project_root = script_dir.parent.parent.parent  # zamin-uq-hydralogy/
sys.path.insert(0, str(project_root / 'hmg_cython'))
...
def main():
    ...
    ppts = inp_dfe.loc[:, 'pptn__ref'].values  # Precipitation.
